              ...
              >
                ...
                <h3
                  className={`text-xl font-bold mb-3 transition-colors duration-300 ${
                    isActive ? 'text-[#495E57]' : 'text-[#45474B]'
                  }`}
                >
                  {step.title}
                </h3>

                <p className="text-[#45474B]/70 mb-4 leading-relaxed">{step.description}</p>

                <div
                  className={`flex items-center text-sm transition-colors duration-300 ${
                    isActive ? 'text-[#495E57]' : 'text-[#45474B]/60'
                  }`}
                >
                  <CheckCircle
                    size={16}
                    className={`mr-2 transition-colors duration-300 ${
                      isActive ? 'text-[#F4CE14]' : 'text-[#495E57]/60'
                    }`}
                    aria-hidden="true"
                  />
                  {step.details}
