...
import { ArrowRight, ArrowLeft, Star, CheckCircle, Heart, Users, Activity } from 'lucide-react';
  ...
  const stories = [
    {
      ...
      quote: "MCMS transformed how we organize our annual children's health camps.",
      achievement: "Served 1,200+ children in underserved communities",
      stats: [
        { icon: <Users size={18} />, value: "1,200+", label: "Children served" },
        { icon: <CheckCircle size={18} />, value: "98%", label: "Satisfaction rate" },
    ...
    },
    {
      ...
      stats: [
        { icon: <Heart size={18} />, value: "5,000+", label: "Patients reached" },
        { icon: <Star size={18} />, value: "24", label: "New volunteers" },
        { icon: <CheckCircle size={18} />, value: "85%", label: "Follow-up rate" }
      ]
    },
    {
      id: 3,
      ...
      quote: "The patient management tools saved us hundreds of hours last quarter.",
      achievement: "Reduced administrative time by 65%",
      stats: [
        { icon: <Users size={18} />, value: "750+", label: "Cardiac screenings" },
