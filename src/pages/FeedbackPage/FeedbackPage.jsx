import { Star, User, MessageSquare, ChevronLeft, Search, Filter } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#F5F7F8] to-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <div className="bg-red-50 border border-red-200 rounded-xl p-8">
            <h2 className="text-2xl font-bold text-red-800 mb-4">Failed to Load Feedback</h2>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#45474B]/70 max-w-3xl mx-auto">
            Read what our participants have to say about their medical camp experiences
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-[#495E57]/10 p-8 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              <h3 className="text-lg font-semibold text-[#45474B] mb-4">Rating Distribution</h3>
              <div className="space-y-3">
                {[5, 4, 3, 2, 1].map((rating) => (
                  <div key={rating} className="flex items-center gap-4">
                    <div className="flex items-center w-12">
                      <span className="text-[#45474B] font-medium">{rating}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {isLoading ? (
            ...
            <div className="col-span-2 text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-[#45474B] mb-2">No feedback found</h3>
              <p className="text-[#45474B]/70">Try adjusting your search criteria or filters.</p>
            </div>
          ) : (
                ...
                <div className="p-6">
                  <div className="flex items-start mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#495E57] font-medium">{feedback.campName}</p>
                    </div>
                  </div>
