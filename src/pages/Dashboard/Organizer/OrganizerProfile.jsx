            ...
            {!editing ? (
              <>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <ProfileField label="Full Name" value={profile.name} icon={<User />} />
                  <ProfileField label="Email" value={profile.email} icon={<Mail />} />
                  <ProfileField label="Phone" value={profile.phone || 'N/A'} icon={<Phone />} />
                  <ProfileField
                    label="Address"
                    value={profile.address || 'N/A'}
                    icon={<MapPin />}
                  />
                  <ProfileField label="Role" value={profile.role || 'N/A'} icon={<Briefcase />} />
                </div>
